    ...
    <script>
        $(document).ready(function () {
            $('#keyword1').on('keyup',function () {
                $.ajax({
                    type: "GET",
                    url: "http://localhost/TTGT/controller/ajax.php?keyword1=" + $(this).val(),
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav">
                ...
                <li>
                    ...
                    ?>  href="http://localhost/TTGT/view/hsvv.php">HỒ SƠ VỤ VIỆC</a>
                </li>
            </ul>
            <!-- Search -->
...
<div class="container-fluid">
    ...
    <div class="col-sm-9">
        ...
        <div class="alert alert-success alert-dismissible" role="alert">
            <div class="panel-title"><h3>Hồ sơ vụ việc</h3></div>

        </div>
        <form action="http://localhost/TTGT/controller/importToDB.php" class="navbar-form navbar-right"  method="POST"
        enctype="multipart/form-data">
            <div class="form-group">
                <input class="form-control"  name="fileExcel" type="file" name="fileToUpload" id="fileToUpload">
            </div>
            <button type="submit" class="btn btn-success" name="btnImportExcel"><span class="glyphicon glyphicon-send" ></span> Gửi</button>
        </form>

        <div>

            <a class="btn btn-primary" href="http://localhost/TTGT/view/CreateReceipt.php">Thêm hồ sơ</a>
        </div>
        <!-- Articles -->
        <div >
            ...
            <div class="card-body">
                <div id="bootstrap-data-table_wrapper"
                    ...
                    <div class="row" id="Result">
                        ...
                        <div class="row">
                            <form class="navbar-form navbar-right" role="search" method="get" action="http://localhost/TTGT/controller/exportToExcel.php">
                                <button  type="submit" class="btn btn-success" name="btnExport">Export To PDF</button>
                            </form>
                        </div>
                    </div>
                    <div class="row">
